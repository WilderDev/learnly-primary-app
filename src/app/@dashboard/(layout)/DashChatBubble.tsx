...
export default function DashChatBubble() {
  ...
  return (
    <>
      {/* Chat Bubble Button */}
      <button
        className="fixed bottom-0 right-0 z-40 m-4 rounded-full bg-gradient-to-tl from-green-500 via-emerald-600 to-green-700 p-4 text-white shadow-lg transition-all hocus:animate-wave hocus:bg-gradient-to-br hocus:from-green-600 hocus:via-emerald-700 hocus:to-green-800 hocus:text-slate-50 hocus:shadow-xl hocus:ring-2 hocus:ring-green-500 hocus:ring-offset-2 hocus:ring-offset-green-500 print:hidden"
