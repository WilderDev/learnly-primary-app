...
const navigation = {
  main: [
    // { name: 'About', href: 'https://www.learnly.ai/about' },
    // { name: 'Blog', href: 'https://www.learnly.ai/blog' },
    // { name: 'Partners', href: 'https://www.learnly.ai/partners' },
    { name: 'Recommended Curriculums', href: '/curriculum-roadmaps' },
  ],
  social: [
    {
      name: 'Facebook',
      href: 'https://www.facebook.com/groups/effortlesshomeschool',
      icon: (props: any) => (
  ...
  return (
    <footer className="bg-white dark:bg-navy-900">
      ...
      <Container className="max-w-7xl">
          ...
          <div className="group relative -mx-4 flex items-center self-stretch p-4 transition-colors hover:bg-slate-100 dark:hover:bg-navy-800 sm:self-auto sm:rounded-2xl lg:mx-0 lg:self-auto lg:p-6">
            ...
            <div className="ml-8 lg:w-64">
              ...
              <p className="text-base font-semibold text-slate-900 dark:text-navy-50">
                <Link href="/curriculum-roadmaps">
                  <span className="absolute inset-0 sm:rounded-2xl" />
                  Browse Our Curriculums
                </Link>
              </p>
        ...
        <div className="flex flex-col relative items-center border-t border-slate-200 pb-12 pt-8 dark:border-navy-700 md:flex-row-reverse md:justify-between md:pt-6">
          {/* Newsletter CTA */}
...
//           <a
//             className="text-sm leading-6 text-slate-600 dark:text-navy-100 dark:hocus:text-navy-50 hocus:text-slate-900"
//             href={item.href}
//             target="_blank"
...
//         <a
//           className="text-slate-400 hocus:text-slate-500 dark:text-navy-200 dark:hocus:text-navy-100"
//           key={item.name}
//           href={item.href}
//           target="_blank"
//           rel="noopener noreferrer"
...
//       ))}
//     </div>
//     <p className="mt-10 text-center text-xs leading-5 text-slate-500 dark:text-navy-200">
//       &copy; Copyright Learnly LLC, {new Date().getFullYear()}. All rights
//       reserved.
//     </p>
...
//       <a href="https://www.learnly.ai/privacy-policy">Our Privacy Policy</a>{' '}
//       has more details.
//     </p>
//   </div>
// </footer>
...
//       {/* CTA */}
//       <div className="group relative -mx-4 flex items-center self-stretch p-4 transition-colors hocus:bg-slate-100 dark:hocus:bg-navy-800 sm:self-auto sm:rounded-2xl lg:mx-0 lg:self-auto lg:p-6">
//         {/* Icon */}
//         <div className="relative flex h-24 w-24 flex-none items-center justify-center">
//           <AcademicCapIcon className="h-10 w-10 flex-none fill-emerald-500" />
//         </div>
